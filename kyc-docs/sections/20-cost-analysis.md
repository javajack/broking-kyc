...
| CKYC Search/Upload | Decentro | Rs.3-10 | TrackWizz | Rs.5-10 |
| e-Sign | Digio | Rs.15-25 | Protean | Rs.5.90 |
| OCR (per doc) | HyperVerge | Rs.1-3 | IDfy | Rs.1-3 |
| Face Match | HyperVerge | Rs.1-2 | IDfy | Rs.1-2 |
| AML Screening | TrackWizz | Rs.5-15 | IDfy | Rs.8-20 |
| Video KYC (if needed) | HyperVerge | Rs.30-50 | Signzy | Contact |
| Income Verify (AA, if F&O) | Setu AA | Rs.5-25 | Perfios ITR | Rs.15-50 |
| Device Intelligence (optional) | Bureau.id | Contact | &mdash; | &mdash; |
| **Total per onboarding (recommended)** | | **Rs.85-175** | (with AA income verify for F&O) | |
| **Total per onboarding (cheapest)** | | **Rs.50-100** | (equity-only, no F&O) | |
| **Total with Setu consolidation** | | **Rs.70-130** | (unified PAN+bank+eSign pricing) | |
