# V5: CKYC (Central KYC) Integration

> **Primary Vendor**: Decentro | **Alternate**: Digio, Arya.ai
...
The batch pipeline (defined in `kyc-flow.md` v2.0) uses SFTP batch for CKYC uploads:
...
|----------|---------|-----------|
| `KYC_MASTER_DATASET.md` | Section A (Fields A25, A29) | CKYC number field, disability flag |
| `KYC_MASTER_DATASET.md` | Section T (Fields T01-T12) | CKYC submission data fields |
| `KYC_MASTER_DATASET.md` | Section R5 (Fields R36-R42) | CKYC search/download result fields |
| `KYC_MASTER_DATASET.md` | Appendix A7 | CKYC constitution type codes |
| `VENDOR_INTEGRATIONS.md` | Section 7 (V5) | Original CKYC vendor research |
| `kyc-flow.md` | Steps 4, 21, Batch Pipeline Step 6 | CKYC search in onboarding, CKYC upload in batch |
...
- [ ] Implement CKYC Upload field mapping from KYC_MASTER_DATASET.md
...
Mapping between the CKYC upload payload and our internal `KYC_MASTER_DATASET.md` fields:
