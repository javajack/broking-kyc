# TrackWizz - AML / PEP / Sanctions Screening

**Vendor**: TrackWizz (https://trackwizz.com/screening.html)
**Integration Code**: V10
**Version**: 1.0
**Date**: 2026-02-13
**Parent Document**: [VENDOR_INTEGRATIONS.md](../../VENDOR_INTEGRATIONS.md) Section 12
...
### 14.3 Data Mapping to KYC_MASTER_DATASET.md
...
*This document should be read alongside [VENDOR_INTEGRATIONS.md](../../VENDOR_INTEGRATIONS.md) (Section 12: V10) and [KYC_MASTER_DATASET.md](../../KYC_MASTER_DATASET.md) (Section K: AML/Compliance) for the complete integration context.*
