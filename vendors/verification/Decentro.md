# Decentro - Vendor Integration Specification

**Version**: 1.0
**Date**: 2026-02-13
**Parent**: [VENDOR_INTEGRATIONS.md](../../VENDOR_INTEGRATIONS.md) (V1, V3, V5)
**Our Use**: PAN Verification, Bank Account Verification (Penny Drop), CKYC Proxy
...
These map to `pan_verify_status` (field R01) in KYC_MASTER_DATASET.md.
...
Referencing `kyc-flow.md` (v2.0, 9-screen flow):
...
*This document is a detailed specification for Decentro integration within our KYC onboarding system. It should be read alongside [VENDOR_INTEGRATIONS.md](../../VENDOR_INTEGRATIONS.md) for the full vendor landscape and [KYC_MASTER_DATASET.md](../../KYC_MASTER_DATASET.md) for field-level data mapping.*
