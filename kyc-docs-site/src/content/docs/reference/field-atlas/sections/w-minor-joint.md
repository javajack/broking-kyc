...
> **Why this page is structured this way:** This is the field-first view for Section W: Minor / Joint / POA Accounts. Each row is one field-destination relationship. To see the same data from the destination's perspective, jump from the [atlas overview](/broking-kyc/reference/field-atlas/).
...
| W-guardian_pan | Guardian PAN | back-office | guardian_minor_pan | CHAR(10) | on-modify | uppercase | required for minor ledger | [industry typical] |
...
| W-holding_type | Holding Type | contract-notes | HoldingPattern | CHAR(2) | on-trade | [direct] | SI/J2/J3 prints on ECN header; joint ECN routed to all holders | [industry typical] |
