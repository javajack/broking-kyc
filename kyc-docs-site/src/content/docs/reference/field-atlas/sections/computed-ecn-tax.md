...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tax-stt_buy_intraday | STT Buy Intraday | contract-notes | STT_Buy_Intra | NUMBER(15,2) | on-trade | derived from Y | 0.025% on sell-side intraday delivery / 0.1% on delivery; rate per Finance Act, computed by CC | NSE/INSP/61999 |
| tax-stt_ctt | Commodity Transaction Tax | contract-notes | CTT | NUMBER(15,2) | on-trade | derived from Y | MCX non-agri commodities sell-side; rate per Finance Act | NSE/INSP/61999 |
