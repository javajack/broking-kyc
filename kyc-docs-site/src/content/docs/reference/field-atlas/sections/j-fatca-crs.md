...
> **Why this page is structured this way:** This is the field-first view for Section J: FATCA/CRS Declaration. Each row is one field-destination relationship. To see the same data from the destination's perspective, jump from the [atlas overview](/broking-kyc/reference/field-atlas/).
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| J-citizenship_country | Citizenship Country | ckyc | CITIZENSHIP | CHAR(3) | one-time | lookup against R | CKYC supports up to 3 citizenship countries | CKYC/2025/16 |
| J-citizenship_country | Citizenship Country | fatca-crs | CITIZENSHIP | CHAR(2) | on-event | [direct] | annual cadence; multi-valued (dual citizens); each citizenship potentially triggers separate CRS reporting | SEBI/HO/MIRSD/SECFATF/P/CIR/2024/12 |
...
| J-fatca_declaration_date | FATCA Declaration Date | fatca-crs | DECLARATION_DATE | DATE YYYYMMDD | on-event | formatted | annual cadence; must be within last 12 months; KRA validates < 1y for re-upload eligibility | SEBI/HO/MIRSD/SECFATF/P/CIR/2024/12 |
...
| J-is_tax_resident_of_india_only | India Tax Resident Only | bse-ucc | FATCA_IN_ONLY | CHAR(1) | one-time | [direct] | FATCA-CRS impact area on UCC master circulars | BSE/20240223-42 |
...
| J-is_tax_resident_of_india_only | India Tax Resident Only | mcx-ucc | FATCA_IN_ONLY | CHAR(1) | one-time | [direct] | FATCA-CRS tagged in UCC submission per onboarding flow | MCX/TECH/394/2023 |
| J-is_tax_resident_of_india_only | India Tax Resident Only | nse-ucc | FATCA_IN_ONLY | CHAR(1) | one-time | [direct] | Y simplifies UCC; N triggers FATCA tax-country annex | NSE/ISC/61817 |
...
| J-is_us_person | US Person Status | fatca-crs | US_PERSON_FLAG | CHAR(1) | on-event | [direct] | annual cadence; triggers FATCA W-9 equivalent; if Y, US TIN/SSN mandatory and J04 (green card) asked | SEBI/HO/MIRSD/SECFATF/P/CIR/2024/12 |
