...
> **Why this page is structured this way:** This is the depth layer. Where the [Compliance Blueprint](/broking-kyc/operations/compliance-blueprint/) inventories *what must be done*, the [Integration DAG](/broking-kyc/operations/integration-dag/) maps *what runs before what*, the [Broker Process Narrative](/broking-kyc/broker-process/narrative/) tells the *chronological story*, the [Field Atlas](/broking-kyc/reference/field-atlas/) maps *where each field flows*, and the [Lifecycle](/broking-kyc/lifecycle/) section walks through *post-onboarding scenarios* — deep dives go *narrowly into one topic* at the level of detail an operator or engineer needs to actually implement or audit it.
