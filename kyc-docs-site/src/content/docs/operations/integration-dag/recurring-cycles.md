...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CYC-WK-CFR | Weekly Client Funding Report submission | EOD daily outputs (×5) | CYC-MO-CLIENT_FUNDING | parallel-with monthly tracks | yes (week-keyed) | 3× then manual | re-submit on revision | by Friday cut-off | exchange portal | [Reporting domain](/broking-kyc/operations/compliance-blueprint/) |
...
| CYC-AN-CYBER_AUDIT | Cyber audit per CSCRF | CSCRF logs (full year) | [exit] | parallel | yes | n/a | n/a | annual / biennial per category | CSCRF report | [Cyber domain](/broking-kyc/operations/compliance-blueprint/) |
| CYC-AN-FIT_PROPER | Annual fit-and-proper self-cert | directors / KMP / senior mgmt | [exit] | parallel | yes (person-keyed) | 1× then escalation | n/a | annual | compliance console | [Member compliance domain](/broking-kyc/operations/compliance-blueprint/) |
