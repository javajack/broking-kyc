...
| TH-PT-MARGIN_LOCK | Compute SPAN+ELM+exposure; reserve against available | TH-PT-SEGMENT_CHECK | TH-PT-MWPL_CHECK | [none] | yes (order-keyed) | none | release margin reservation | < 2ms | OMS reject | [Margin compliance domain](/broking-kyc/operations/compliance-blueprint/) |
...
| TH-TG-DETECT | Technical glitch event detection | [event-trigger] | TH-TG-REPORT | parallel | yes (incident-id) | none (event-triggered) | [none] | event-driven | ops console | [Cyber security / technical glitch SEBI Aug-2023 circular](/broking-kyc/operations/compliance-blueprint/) |
