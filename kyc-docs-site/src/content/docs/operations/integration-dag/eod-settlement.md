...
| EOD-CN-GENERATE | ECN PDF generation with DSC sign | EOD-CHARGE-COMPUTE | EOD-CN-DISPATCH | [none] | yes (trade-id keyed) | 3× then manual | regenerate on detected error | < 60m | back-office / DSC service | [Investor servicing domain](/broking-kyc/operations/compliance-blueprint/) |
| EOD-CN-DISPATCH | DLT SMS + email per template | EOD-CN-GENERATE | [exit] | parallel-with other EOD streams | yes (msg-id keyed) | 3× then DLT retry | [none] | < 24h cumulative | ops queue / DLT reject | [DLT comms compliance](/broking-kyc/operations/compliance-blueprint/) |
