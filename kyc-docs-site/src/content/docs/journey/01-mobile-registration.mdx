...
This device intelligence layer runs silently in the background. No user interaction required. Results feed into the AML/fraud evaluation at the [Blocking Gate (Screen 8)](/journey/08-declarations-gate/).
