...
|--------|-------------|-----------|----------|
| **TrackWizz** <VendorBadge type="recommended" /> | India-specific: SEBI (Securities and Exchange Board of India) debarred, RBI defaulters, MHA lists. Fuzzy matching. Ongoing monitoring with webhooks. | 120+ | Rs.5-15 |
