...
| 2 | **Government identity sources for IPV exemption** | Aadhaar eKYC via DigiLocker consent provides IPV exemption per [SEBI/HO/MIRSD/DOP/CIR/P/2020/73](/broking-kyc/reference/circulars/sebi-mirsd/#sebi-ho-mirsd-dop-cir-p-2020-73). Identity fields are sourced from government-issued digital documents. |
