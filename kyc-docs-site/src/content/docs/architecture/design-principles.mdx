...
<Aside type="tip">
These principles directly map to the [9-screen user journey](/journey/). Each screen is designed to collect the minimum input while maximizing pre-filled data from trusted sources.
</Aside>
